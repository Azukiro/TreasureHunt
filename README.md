...
The project documentation, generated by Doxygen from XML comments in the C\# code, can be accessed by opening the `Documentation/html/index.html` file in a web browser. 
